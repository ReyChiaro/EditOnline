...
from pipelines.pipeline_utils import get_nested_attr, summarize_model
from pipelines.fsdp_handler import parallel_handler
from pipelines.fsdp_strategy import FSDPStrategy
...
class QwenImageEditPlus:
    ...
    def prepare_forward_inputs(self, preprocessed_data: PreprocessOutput) -> QwenForwardOutput:
        r"""
